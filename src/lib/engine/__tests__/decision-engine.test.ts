...
describe('Decision Engine', () => {
  ...
  describe('Product Validation', () => {
    it('should deny claim for non-existent product', () => {
    ...
    it('should pass validation for existing product', () => {
      const decision = evaluateClaimDecision(baseClaimInput);
  ...
  describe('Flight Data Fetch', () => {
    it('should deny claim for non-existent flight', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
    ...
    it('should fetch flight data for valid flight', () => {
      const decision = evaluateClaimDecision(baseClaimInput);
  ...
  describe('Exclusion Check', () => {
    it('should deny claim for force majeure delay (excluded by default)', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
        flightNo: 'DL300',
    ...
    it('should deny claim for crew strike delay (excluded by default in EU product)', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
        flightNo: 'IB400',
    ...
    it('should pass exclusion check for operational delay', () => {
      const decision = evaluateClaimDecision(baseClaimInput);
    ...
    it('should allow weather delay when weather exclusion is disabled', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
        flightNo: 'AA200',
        flightDate: '2024-12-20',
  ...
  describe('Payout Tier Matching', () => {
    it('should deny claim for delay below minimum threshold', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
    ...
    it('should deny claim for on-time flight', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
    ...
    it('should approve claim with tier 1 payout (60-120 min delay)', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
    ...
    it('should approve claim with tier 2 payout (121-240 min delay)', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
    ...
    it('should approve claim with tier 3 payout (241-480 min delay)', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
    ...
    it('should approve claim with tier 4 payout (481+ min delay)', () => {
      const claim: ClaimInput = {
        ...baseClaimInput,
  ...
  describe('Decision Output Structure', () => {
    ...
    it('should include trace steps for each evaluation rule', () => {
      const decision = evaluateClaimDecision(baseClaimInput);
  ...
  describe('Product Version Handling', () => {
    it('should use specified version config when available', () => {
...
describe('Audit Artifact Export', () => {
  it('should export decision as valid JSON', () => {
    const claim: ClaimInput = {
  ...
  it('should include decision, timestamp, and user in artifact', () => {
    const claim: ClaimInput = {
